...
import triphibiousDropship from "../../../../../data/cardImages/Triphibious Dropship.jpg";
        ...
        <>
            ...
            <main className="faq-page">
                ...
                <div className="container">
                    ...
                    <section>
                        <CardImage src={triphibiousDropship} lazy />
                        <div className="section-content">
                            <h3>Triphibious Dropship</h3>
                            <ul>
                                <li>
                                    The second ability triggers when blockers are declared and no blockers are declared
                                    for Triphibious Dropship. It is therefore too late for the creature put into play to
                                    have any blockers declared for it, so that creature effectively cannot be blocked.
                                </li>
                            </ul>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="section-content">
                            ...
                            <ul>
                                <li>
                                    X is set as you cast the spell. The token created does not update its power and
                    ...
                    <section>
                        ...
                        <div className="section-content">
                            <h3>
                                Murmur's Command, Wormcaller's Command, Ingolf's Command, Vuissance's Command, Ntombi's
                                Command
                            </h3>
                            <ul>
                                <li>
                    ...
                    <section>
                        ...
                        <div className="section-content">
                            ...
                            <ul>
                                ...
                                <li>
                                    The value of X chosen when you activate Umida's fourth activated ability doesn’t
                                    have to be the same value of X that you chose when you cast him.
                                </li>
                                <li>
                                    For Umida's fourth ability, as an example: If you spend 1 loyalty counter, you'll
                                    get a single creature with mana value 1 or less. If you spend 2 loyalty counters,
                                    you'll get two creatures each with mana value 2 or less. If you spend 3 loyalty
                                    counters, you'll get three creatures, each with mana value 3 or less. And so on.
                                </li>
                            </ul>
                        </div>
                    </section>
                        ...
                        <div className="section-content">
                            ...
                            <ul>
                                <li>
                                    ...
                                    shuffle no cards from your graveyard into your library (and shuffle The Aion into
                                    your library).
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="section-content">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    Crow, the effects of the first ability continue to apply while Formling is a copy of
                                    Storm Crow so it will still have infiltrate.
                                </li>
                            </ul>
                        </div>
                    </section>
